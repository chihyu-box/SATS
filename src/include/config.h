...
namespace sats::config
{
    ...
    inline sc_core::sc_time CYCLE_TIME = sc_core::sc_time(1.0, sc_core::SC_NS);
    ...
    constexpr size_t SPAD_CREDIT_SIZE = N_BANKS;   // maximum outstanding scratchpad requests per controller
    constexpr size_t LOAD_N_DATA_BUF = 16;         // maximum outstanding dram requests for load controller
    constexpr size_t STORE_N_DATA_BUF = 8;         // maximum outstanding dram requests for store controller
